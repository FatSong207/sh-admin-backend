...
type Log struct {
	...
	Response     string        `json:"response" form:"response"`           // ResponseBody
...
type LogOutDto struct {
	...
	UserName string `json:"userName" form:"user_name" gorm:"-"` //用戶姓名
}
...
type LoginlogOutDto struct {
	...
	Email string `json:"email" form:"email" gorm:"-"` //登入帳號（Email）
}
